...
**Protocol maturity:** substrate law **v0.5.0**; **`gantry` v2.3.0** — unified CLI naming (`gantry` primary; legacy `gapman` alias). Current npm publish: **v2.3.0**. See [.gitagent/planner/RUNTIME.md](.gitagent/planner/RUNTIME.md).
