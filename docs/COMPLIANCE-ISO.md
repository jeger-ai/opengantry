...
| **ISO 27001 — Audit logs** | Record of who/what changed systems | `WORKER_LOG.md` + greppable `[MSN-XXXX]` commits + mission file history | Quote-matching is forensic process control, not immutable crypto logs |
