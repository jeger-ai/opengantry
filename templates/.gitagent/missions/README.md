...
```bash
gapman legislate "<intent>" --msn MSN-0001 --skill-key <manifest-key>
```

Duplicate `msn_id` values fail closed by default; use `--allow-duplicate` only for intentional migration flows.
