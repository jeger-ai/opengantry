...
export const VALID_ARCHITECTURE_KINDS = new Set<ArchitectureDocKind>([
  "file",
  "directory",
  "external",
  "unset",
...
export const DEFAULT_ARCHITECTURE_ACCESS_SKILL = REL_ARCHITECTURE_ACCESS_SKILL;
export const DEFAULT_ARCHITECTURE_DISCOVERY_SKILL = REL_ARCHITECTURE_DISCOVERY_SKILL;
export { REL_ARCHITECTURE_POINTER };
