...
5. **Register:** `gapman register` emits skill proposals only; Teacher owns `MANIFEST.json` (Rule 4.4).
...
- No hash ledger as security root; authorization is Teacher identity + CI signatures.
